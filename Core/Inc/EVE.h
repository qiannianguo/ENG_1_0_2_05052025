...
//This is a normal text color to give maximum visibility on the black background
#define HIGH_VIS_TEXT_COLOR 0x00,0xff,0x00 	 	//lime   0x0,  0xff, 0x0
#define HIGH_VIS_TEXT_COLOR_24bit 0x00ff00
#define HIGH_VIS_ALARM_COLOR 0xff,0xff,0x00 	//yellow 0xff, 0xff, 0x0
#define HIGH_VIS_ALARM_COLOR_24bit 0xffff00
#define HIGH_VIS_BG_COLOR 0x00,0x00,0x00     	//Black background color
#define HIGH_VIS_BG_COLOR_24bit 0x000000
#define BLACK_COLOR 0x00,0x00,0x00
#define WHITE_COLOR 0xff,0xff,0xff
#define WHITE_COLOR_24bit 0xffffff
#define RED_COLOR 0xff,0x00,0x00
#define RED_COLOR_24bit 0xff0000
#define GREEN_COLOR 0x00,0x80,0x00
#define GREEN_COLOR_24bit 0x008000
#define ROYAL_BLUE_COLOR_24bit 0x4169e1
#define EVE_COLOR_RGB_24(color) EVE_COLOR_RGB(((color)>>16)&0xFF, ((color)>>8)&0xFF, (color)&0xFF)
/****************************************
