...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC4     ------> ADC_IN14
    */
    GPIO_InitStruct.Pin = AD_IN0_Pin|AD_IN1_Pin|AD_IN5_Pin|AD_IN6_Pin
                          |AD_IN7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AD_IN13_Pin|AD_IN14_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AD_IN14_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC_IN14
    */
    HAL_GPIO_DeInit(GPIOA, AD_IN0_Pin|AD_IN1_Pin|AD_IN5_Pin|AD_IN6_Pin
                          |AD_IN7_Pin);

    HAL_GPIO_DeInit(AD_IN14_GPIO_Port, AD_IN13_Pin|AD_IN14_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DA1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA4     ------> DAC_OUT1
    */
    HAL_GPIO_DeInit(DA1_GPIO_Port, DA1_Pin);
